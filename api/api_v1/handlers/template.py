...
# TODO: Add zip file upload
@template_router.post('/create',
                      summary='Add Template',
                      response_model=TemplateSummary)
async def create_template(data: TemplateCreate, user: User = Depends(current_user)):
...
@template_router.put('/{template_id}',
                     ...
                     response_model=TemplateDetail)
async def update(template_id: UUID, data: TemplateUpdate, user: User = Depends(current_user)):
